...
class SelectSubPart extends StatefulWidget {
  final String categoryId;

  const SelectSubPart(this.categoryId, {Key? key}) : super(key: key);

  static Widget screen(String categoryId) => BlocProvider(
        create: (context) =>
            di<SelectPartBloc>()..add(GetSelectSubPartEvent(categoryId)),
        child: SelectSubPart(categoryId),
      );

  @override
  _SelectSubPartState createState() => _SelectSubPartState();
}

class _SelectSubPartState extends State<SelectSubPart> {
      ...
      child: Container(
        ...
        child: BlocBuilder<SelectPartBloc, SelectPartState>(
          builder: (context, state) {
            if (state is SelectSubPartSuccess) {
              return Column(
