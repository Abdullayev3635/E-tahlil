...
class YuborilmaganPage extends StatefulWidget {
  const YuborilmaganPage({Key? key}) : super(key: key);

  @override
  _YuborilmaganPageState createState() => _YuborilmaganPageState();
}

class _YuborilmaganPageState extends State<YuborilmaganPage> {
  @override
